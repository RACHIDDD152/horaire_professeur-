...
if(isset($_POST["submit"])) {
  ...
  $sql="  UPDATE record  SET ename='$enamee' , ssn='$ssne', dept='$depte',  salary='$salarye', homeaddress='$homee' WHERE id='$SearchQueryParameter'";
 ...
 $stmt = $connect->query($sql); 
        ...
        if ( $stmt )
        {
         ...
         echo '<script> window.open("afficher.php?id=update sucsessfly","_self")</script>';
