...
if(isset($_POST["submit"])) {
if(!empty($_POST["uname"]) && !empty($_POST["ucharge"])){
	$name = $_POST['uname'];
    $chargeh = $_POST['ucharge'];
 ...
 $stmt = $connect->prepare("INSERT INTO matiere  (nommatiere,chargehoraire,idprof) VALUES ( '$name', '$chargeh',0);"); 
...
<form class="" action="ajoutermatiere.php" method="post">
	<div  style="margin: 0px;" class="card bg-secondary text-light mb-3" >
		...
		<div class="card-body bg-dark">
			...
			<div class="form-group">
				...
				<input type="text"  id="password" class="form-control" name="ucharge">
		...
		<footer style="height: 100%; " class="bg-dark text-white">
			<div class="container">
				<div class="row">
					<div class="col"></div>
					<p class="lead text-center"> <span id="year"></span>   theme</p>
