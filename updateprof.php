...
if(isset($_POST["submit"])) {
  ...
  $sql="  UPDATE addprof  SET nom='$name' , pass='$pass', age='$agee',  email='$mail', specialite='$spes' WHERE idprof=6 ";
...
<body>
 ...
 ?>
	<form class="" action="updateprof.php?id=<?php echo $SearchQueryParameter ; ?>" method="post">
